  ...
  opts = {
    options = {
      ...
      diagnostics_indicator = function(count, level)
        ...
        local icon = severity and require("ray.config.diagnostics").sign(severity) or "•"
  ...
  config = function(_, opts)
    ...
    Hydra({
      ...
      heads = {
        ...
        { "c", "<cmd>BufferLinePickClose<cr>", { desc = "Pick close", group = "Close" } },
        { "C", "<cmd>BufferLineCloseOthers<cr>", { desc = "Close rest", group = "Close" } },
        { "H", "<cmd>BufferLineCloseLeft<cr>", { desc = "Close left", group = "Close" } },
        { "L", "<cmd>BufferLineCloseRight<cr>", { desc = "Close right", group = "Close" } },
